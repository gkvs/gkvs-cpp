...
#define	ROTL32(x,y)	murmur3_rotl32(x,y)
#define ROTL64(x,y)	murmur3_rotl64(x,y)
...
uint32_t gkvs::MurMur3::hash32(const void * key, int len)
{
...
uint64_t* gkvs::MurMur3::hash128( const void * key, const int len)
{
    const uint8_t * data = (const uint8_t*)key;
